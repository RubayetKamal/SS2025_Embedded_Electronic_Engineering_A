...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\linewidth]{Disjoint path.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\linewidth]{Partitioning using Control Node.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\linewidth]{Compatiblity graph.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\linewidth]{Clique.png}
